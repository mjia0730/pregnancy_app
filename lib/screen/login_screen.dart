...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Disease disease = Disease(
      ...
      weeks_pregnant: 0,
      fatigue: false,
      one_hour_plasma_glucose_level: 0.0,
      gestational_diabetes_history: false,
      systolic_blood_pressure: 0,
      diastolic_blood_pressure: 0,
      haemoglobin_level: 0.0,
      calcium_level: 0.0,
      phosphate_level: 0.0,
      urine_protein_level: 0.0,
      blood_creatinine_level: 0.0,
      blood_urea_nitrogen_level: 0.0,
      vitamin_c_level: 0.0,
      gingivitis: false,
      ldlc_level: 0.0,
      hdlc_level: 0.0,
        ...
        value.docs.forEach((element) {
          _firestore.collection('user').doc(element.id).get().then((value) {
            user = Users(
                ...
                emergency_contact: value['emergency_contact'].toString(),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        textAlign: TextAlign.left,
                        decoration:
                            TextFieldDecoration.copyWith(hintText: '********'),
                        onChanged: (value) {
                          setState(() {
                            password = value;
                          });
